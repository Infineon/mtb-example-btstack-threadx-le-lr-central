 ...
 ****************************************************************************/
    ...
    const wiced_bt_cfg_ble_scan_settings_t cy_bt_cfg_scan_settings =
    {
        ...
        .high_duty_scan_interval         = 100,                                 /* High duty scan interval (in slots (1 slot = 0.625 ms)) */
        .high_duty_scan_window           = 80,                                   /* High duty scan window (in slots (1 slot = 0.625 ms)) */
        ...
        .conn_min_interval               = 100,                                       /* Minimum connection interval (in slots (1 slot = 1.25 ms)) */
        .conn_max_interval               = 200,                                       /* Maximum connection interval (in slots (1 slot = 1.25 ms)) */
